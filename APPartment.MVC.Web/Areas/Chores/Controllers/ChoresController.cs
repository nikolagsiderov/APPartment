...
namespace APPartment.MVC.Web.Areas.Chores.Controllers
{
    ...
    public class ChoresController : BaseCRUDController<ChoreDisplayViewModel, ChorePostViewModel>
    {
        ...
        {
            model.ActionsHtml.Add(ObjectActionBuilder.BuildCustomAction(APPAreas.Chores, nameof(Assign), model.ID, "btn-outline-warning", "fas fa-tag"));
            await base.SetObjectActions(model);
        }

        public override async Task SetGridItemActions(ChoreDisplayViewModel model)
        {
            model.ActionsHtml.Add(GridItemActionBuilder.BuildCustomAction(APPAreas.Chores, nameof(Assign), model.ID, "btn-outline-warning", "fas fa-tag"));
