...
namespace APPartment.MVC.Web.Areas.Surveys.Controllers
{
    ...
    public class SurveysController : BaseCRUDController<SurveyDisplayViewModel, SurveyPostViewModel>
    {
        ...
        {
            var survey = await APPI.RequestAsync<SurveyPostViewModel>(new string[] { CurrentAreaName, CurrentControllerName, id.ToString() }, CurrentUserID, CurrentHomeID);
            survey.Active = true;

            await APPI.PostAsync(survey, new string[] { CurrentAreaName, CurrentControllerName }, CurrentUserID, CurrentHomeID);
        ...
        public async Task<IActionResult> CreateStandardAnswer(string questionID, bool isCorrect, string answer)
        {
            ...
            await APPI.PostAsync(model, new string[] { CurrentAreaName, "Answers" }, CurrentUserID, CurrentHomeID);
            return Ok();
        }
        ...
        public async Task<IActionResult> CreateQuestion(long id) // surveyID
        {
            ...
            var questionTypes = await APPI.RequestManyAsync<SurveyQuestionTypeLookupViewModel>(new string[] { CurrentAreaName, "QuestionTypes" }, CurrentUserID, CurrentHomeID);
        ...
        public async Task<IActionResult> CreateQuestion(string surveyID, string question, string typeID)
        {
            ...
            var savedQuestion = await APPI.PostReturnAsync(model, new string[] { CurrentAreaName, nameof(this.Questions) }, CurrentUserID, CurrentHomeID);
        ...
        {
            await APPI.DeleteAsync(new string[] { CurrentAreaName, nameof(this.Questions), ID }, CurrentUserID, CurrentHomeID);
            return Ok();
        }
        ...
        {
            var model = await APPI.RequestAsync<SurveyPostViewModel>(new string[] { CurrentAreaName, CurrentControllerName, id.ToString() }, CurrentUserID, CurrentHomeID);
        ...
        {
            var model = await APPI.RequestAsync<SurveyPostViewModel>(new string[] { CurrentAreaName, CurrentControllerName, ID }, CurrentUserID, CurrentHomeID);
            ...
            await APPI.PostAsync(model, new string[] { CurrentAreaName, CurrentControllerName }, CurrentUserID, CurrentHomeID);
        ...
        public override async Task SetObjectActions(SurveyPostViewModel model)
        {
            ...
            if (model.Active == false)
                model.ActionsHtml.Add(ObjectActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Activate), model.ID, "btn-outline-warning", "fas fa-level-up-alt"));
            else
                model.ActionsHtml.Add(ObjectActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Inactivate), model.ID, "btn-outline-warning", "fas fa-level-down-alt"));

            model.ActionsHtml.Add(ObjectActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Assign), model.ID, "btn-outline-warning", "fas fa-tag", null, true));
            model.ActionsHtml.Add(ObjectActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(CreateQuestion), model.ID, "btn-outline-warning", "fas fa-question", "Create a question", true));
            model.ActionsHtml.Add(ObjectActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Questions), model.ID, "btn-outline-warning", "fas fa-question", "View questions", true));
        }
        ...
        public override async Task SetGridItemActions(SurveyDisplayViewModel model)
        {
            ...
            if (model.Active == false)
                model.ActionsHtml.Add(GridItemActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Activate), model.ID, "btn-outline-warning", "fas fa-level-up-alt"));
            else
                model.ActionsHtml.Add(GridItemActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Inactivate), model.ID, "btn-outline-warning", "fas fa-level-down-alt"));

            model.ActionsHtml.Add(GridItemActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Assign), model.ID, "btn-outline-warning", "fas fa-tag", null, true));
            ...
            var createQuestion = GridItemActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(CreateQuestion), model.ID, "btn-warning", "fas fa-question", "Create a question", true, true);
            var questions = GridItemActionBuilder.BuildCustomAction(APPAreas.Surveys, nameof(Questions), model.ID, "btn-warning", "fas fa-question", "View questions", true, true);
