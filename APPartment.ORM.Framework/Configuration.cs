namespace APPartment.ORM.Framework
{
    public static class Configuration
    {
        ...
        private static string SashoConnectionString = "Server=DESKTOP-MUOBF1E\\SQLEXPRESS;Database=APPartment;Trusted_Connection=True;MultipleActiveResultSets=true";
