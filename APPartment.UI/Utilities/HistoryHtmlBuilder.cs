...
//                var historyEventString = new StringBuilder();
//                var username = $"<strong>{context.Users.Find(historyEvent.UserId).Name}</strong>";
//                var isSubObject = historyEvent.TargetObjectId == null ? false : true;
//                long objectType = 0;
...
//                                        {
//                                            var assignedUserUsername = context.Users.Where(x => x.Id == long.Parse(newValues[column])).FirstOrDefault().Name;
